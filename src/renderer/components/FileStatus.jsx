...
const notSaveImagePath = "M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 " +
    ...
    saveImagePath = "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 " +
...
export default function FileStatus () {
    ...
    let fileStatusPathCommand = saveImagePath;
    const isSaved = getFileStatus(useSelector((state) => state));
    if (!isSaved) {

        fileStatusPathCommand = notSaveImagePath;
